    ...
    <div style={{paddingTop:'100px'}}>
     ...
     <div className="container-fluid my-5 row">
      <div className="col-lg-6">
        <h3>All Videos</h3>
        <View  setRemoveVideoResponseFromView={setRemoveVideoResponseFromView} videoUploadResponse={videoUploadResponse} removeVideoResponseFromCategory={removeVideoResponseFromCategory}/>
      </div>
      <div className="col-lg-6">
